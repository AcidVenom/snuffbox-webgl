...
export function Effect(name, data, context, loader)
{
    ...
    function Pass(name, passDefinition, context)
    {
        ...
        var _validateDepthState = function()
        {
            ...
            var valid = _depthState.Enabled !== undefined && _depthState.DepthTest !== undefined;
            if (valid == false)
            {
                console.warn("Invalid depth state for a shader pass: Enabled (" + _depthState.Enabled + "), DepthTest (" + _depthState.DepthTest + ")");
            }
        ...
        this.apply = function(context)
        {
            ...
            {
                context.depthMask(_depthState.Enabled);
