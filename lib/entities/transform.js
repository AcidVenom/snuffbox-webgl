...
export function Transform()
{
    ...
    {
        if (_dirty == false && (forced == undefined || forced == false))
        {
            return;
        }
    ...
    /**
     * Translates the current transform relative to world coordinates, from individual values or a vector
     */
    this.translateWorld = function(x, y, z)
    {
        ...
        _localTranslation = glm.Vector3.add(_localTranslation, _localTranslation, glm.Vector3.fromValues(x, y, z));
        this.markDirty();
    }
    //--------------------------------------------------------------------------------------------
