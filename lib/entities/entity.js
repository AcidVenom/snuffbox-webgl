...
export function Entity(scene)
{
    ...
    /**
     * Virtual function, override for behavior when the entity is instantiated
     * @param {Scene} scene The scene this entity is going to be spawned in
     */
    ...
    /**
     * Virtual function, override for behavior when the entity is spawned in the scene
     * @param {Scene} scene The scene this entity was spawned in
     */
    this.onStart = function(scene)
    {
    ...
    /**
     * Virtual function, override for behavior every update
    ...
    /**
     * Virtual function, override for behavior before destruction
     */
